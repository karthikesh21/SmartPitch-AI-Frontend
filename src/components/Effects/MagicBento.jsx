...
const cardData = [
  ...
  },
  {
    ...
    description: 'Professional outreach that gets replies',
  ...
  },
  {
    ...
    description: 'Confident phone conversations',
    label: 'B2B Sales',
    icon: '📞'
  },
  {
    color: '#060010',
    title: 'Ad Copy',
    description: 'Click-worthy advertisements',
    label: 'Marketing',
    icon: '📢'
  },
  {
    color: '#060010',
    title: 'AI Powered',
    description: 'GPT-4 & Groq LLM integration',
    label: 'Technology',
    icon: '🤖'
  },
  {
...
const MagicBento = ({
  ...
  const activeCards = customCards || cardData;
